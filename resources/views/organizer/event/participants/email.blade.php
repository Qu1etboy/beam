            ...
            <div>
                ...
                <form class="space-y-3">
                    ...
                    <div>
                        ...
                        <x-text-input id="accepeted_email_subject" name="accepeted_email_subject" placeholder="Email subject" />
                    ...
                    <div>
                        ...
                        <textarea id="accepeted_email_body" class="ckeditor form-control" name="accepeted_email_body"></textarea>
                    </div>
            ...
            <div>
                ...
                <form class="space-y-3">
                    ...
                    <div>
                        ...
                        <x-text-input id="rejected_email_subject" name="rejected_email_subject" placeholder="Email subject" />
                    ...
                    <div>
                        ...
                        {{-- <textarea id="rejected_email_body" class="ckeditor form-control" name="rejected_email_body"></textarea> --}}
                    </div>
