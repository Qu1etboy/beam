    ...
    <div class="grid lg:grid-cols-5 w-full">
      ...
      <div class="p-4 col-span-4">
        ...
        <nav class="flex items-center justify-between gap-5 border rounded-lg w-full p-3 mb-8">
          <div class="space-x-5">
            <a href="{{ route('organizer.event.tasks.list') }}" class="hover:text-emerald-500 duration:300">List</a>
            <a href="{{ route('organizer.event.tasks.board') }}" class="hover:text-emerald-500 duration:300">Board</a>
          </div>
