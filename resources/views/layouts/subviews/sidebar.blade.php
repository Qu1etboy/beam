<aside class="px-3 py-10 lg:h-screen lg:overflow-y-auto w-full" style="background-color:#18181A">
  ...
  <div class="space-y-2 py-4 text-white">
    ...
    <a href="{{ route('question.index',['organizer' => $organizer->id, 'event' => $event->id]) }}" class="{{ request()->routeIs('question.index') ? 'bg-purple-600 block hover:bg-purple-900 rounded-lg px-2.5 py-3' : 'block hover:bg-purple-900 rounded-lg px-2.5 py-3' }}">Registrant Questions</a>
